...
const rows = [
  ...
  { id: 'when', numeric: false, disablePadding: false, label: 'Fecha de ingreso' },
  { id: 'status', numeric: false, disablePadding: false, label: 'Estado' },
  { id: 'packages', numeric: true, disablePadding: false, label: 'Bultos' },
  { id: 'items', numeric: true, disablePadding: false, label: 'Items' },
  { id: 'priority', numeric: false, disablePadding: false, label: 'Prioritario' },
];
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell numeric>{n.packages}</TableCell>
                      <TableCell numeric>{n.items}</TableCell>
                      <TableCell>{n.priority ? 'Si' : 'No'}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
