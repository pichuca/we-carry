...
function createData(name, calories, fat, carbs, status) {
  counter += 1;
  return { id: counter, name, calories, fat, carbs, status };
}
...
const rows = [
  { id: 'name', numeric: false, disablePadding: true, label: 'Comprador' },
  { id: 'calories', numeric: true, disablePadding: false, label: 'SKU' },
  { id: 'fat', numeric: true, disablePadding: false, label: 'Productos' },
  { id: 'carbs', numeric: true, disablePadding: false, label: 'Tracking' },
...
class EnhancedTable extends React.Component {
  state = {
    ...
    data: [
      ...
      createData('Lucas Camacho', 237, 9.0, 37, 'Entregado'),
